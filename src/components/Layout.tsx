        ...
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center">
            <span className="text-2xl font-bold tracking-tighter text-primary-dark">
              A.G <span className="text-primary">Landscape</span>
            </span>
          </Link>
          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-2">
              ...
              <div className="pt-4 px-2">
                ...
                >
                  <Phone size={20} /> Call Now: 951-858-0669
                </a>
              </div>
            </div>
          </motion.div>
    ...
    <footer className="bg-gray-900 text-white pt-24 pb-24 md:pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 lg:col-span-1">
            ...
            <p className="text-gray-400 mb-8 leading-relaxed">
              Providing professional landscaping services including lawn care, irrigation systems, property maintenance and much more in Chula Vista, CA.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:9518580669" className="hover:text-white transition-colors">951-858-0669</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="text-primary flex-shrink-0" size={20} />
                <a href="mailto:info@aglandscape.com" className="hover:text-white transition-colors">info@aglandscape.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          <p>© {new Date().getFullYear()} A.G Landscape & Irrigation. All rights reserved.</p>
  ...
  return (
    <AnimatePresence>
      {scrolled && (
        ...
        >
          <a href="tel:9518580669" className="flex-1 flex flex-col items-center justify-center py-5 text-primary-dark font-bold border-r border-gray-200 hover:bg-gray-50 active:bg-gray-100 transition-colors">
            <Phone size={24} className="mb-1" />
            <span className="text-sm">Call Now</span>
          </a>
          <a href="sms:9518580669" className="flex-1 flex flex-col items-center justify-center py-5 text-primary font-bold hover:bg-gray-50 active:bg-gray-100 transition-colors">
